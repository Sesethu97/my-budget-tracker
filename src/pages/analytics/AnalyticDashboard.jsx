...
function AnalyticDashboard({ username }) {
          ...
          <div className="p-6 grid grid-cols-12 gap-6">
            <div className="col-span-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              <div
                ...
                className="flex flex-col items-start gap-3 w-full p-5  hover:shadow-xl border bg-sidebarColor border-mainText rounded-xl shadow-md transition"
              >
