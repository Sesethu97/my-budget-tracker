...
function Landing() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-backgroundColor/5"></div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center">
        ...
        <button
          onClick={handleStart}
          className="mt-6 px-6 py-3 bg-white text-black rounded-xl font-semibold hover:bg-subText transition"
        >
          Get Started
        </button>
      </div>
